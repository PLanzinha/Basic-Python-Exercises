...
# on the blog, so you can either choose to use the original directive and read about the set
...
b = random.sample(range(1, 100), 4)
c = []
c.extend(x for x in a + b if x not in c)
